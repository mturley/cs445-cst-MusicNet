    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $.each(r.results, function(idx, shop) {
          var $li = $('<li><a href="'+shop.store_link+'"><img src="'+shop.store_img+'"class="ad" align="left"></a><div class="storeInfo" style="valign:center">Store Name: '+store.store_name+'</div></li>');
          $li.appendTo($ul);
